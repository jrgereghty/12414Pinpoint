...
public class Test extends OpMode {
    ...
    private final Pose startPose = new Pose(124, 24, Math.toRadians(180));

    /** Scoring Pose of our robot. It is facing the submersible at a -45 degree (315 degree) angle. */
    private final Pose endPose = new Pose(84, 24, Math.toRadians(0));
    private PathChain pathToEnd, pathToStart;
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                follower.followPath(pathToEnd, true);
                setPathState(1);
                break;
            case 1:
